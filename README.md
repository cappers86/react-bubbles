...
A token is basically used to grant access by producing a acces token which is linked to the client credentials. which allows users acces to protected routes.

- [ ] What steps can you take in your web apps to keep your data secure?

    a good way would be to avoid using plain text credentials 

- [ ] Describe how web servers work.

  The servers recieve requests from clients then the requested data is returned.
